...
function Linux:Create(config)
    ...
    function Window:Tab(name, icon)
        ...
        TabButton.Font =1 Enum.Font.SourceSans
        ...
        TabButton.MouseButton1Click:Connect(function()
            ...
            TabButton.BorderColor3 = Color3.fromRGB(128, 0, 128)
        end)
        ...
        TabContainer.CanvasSize = UDim2.new(0, #Tabs * 100, 0, 0)
        ...
        function Tab:Toggle(name, default, callback)
            ...
            ToggleKnob.BackgroundColor3 = default and Color3.fromRGB(128, 0, 128) or Color3.fromRGB(150, 150, 150)
            ...
            ToggleSwitch.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    local newColor = state and Color3.fromRGB(128, 0, 128) or Color3.fromRGB(150, 150, 150)
            ...
            Content.CanvasSize = UDim2.new(0, 0, 0, #TabContent:GetChildren() * 45)
        end
